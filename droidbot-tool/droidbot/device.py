...
DEFAULT_INTERACTIVE_DISPLAY_COORDINATES = {"MIN_X":0, "MAX_X":1080, "MIN_Y":0, "MAX_Y":1776}
...
class Device(object):
    ...
    def __init__(self, device_serial=None, is_emulator=False, output_dir=None,
        ...
        self.interactive_coordinates = DEFAULT_INTERACTIVE_DISPLAY_COORDINATES
    ...
    def take_screenshot_using_adb(self):
    ...
    def get_current_state(self):
        ...
        try:
            ...
            current_state = DeviceState(self,
                                        ...
                                        #, screenshot_path=screenshot_path) CLAUDIO SIMONE
    ...
    def view_set_text(self, new_text, view_id=None):
        ''' questo era il codice originale SIMONE
         if self.droidbot_ime.connected:
    ...
    def set_orientation(self, orientation_code=0):
        self.adb.rotate(orientation_code=orientation_code)

    def rotate_left(self):
        orientation_code = self.adb.get_orientation()
        if orientation_code == 0:
            orientation_code = 3
        else:
            orientation_code -= 1
        self.set_orientation(orientation_code)
    ...
    def get_views_with_uiautomator(self):
        return self.adb.get_views_with_uiautomator()
    ...
    def handle_rotation(self):
        ...
        from .input_policy import POLICY_DATA_LOSS
        if DroidBot.get_instance().input_manager.policy_name == POLICY_DATA_LOSS:
            return
